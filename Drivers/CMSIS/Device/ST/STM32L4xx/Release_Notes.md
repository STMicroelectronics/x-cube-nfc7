...
<label for="collapse-section26" aria-hidden="true">V1.7.3 / 07-June-2023</label>
<div>
...
<label for="collapse-section25" aria-hidden="true">V1.7.2 / 26-November-2021</label>
<div>
...
- **Headline**
  ...
  - **STM32L476xx.h** header file: Add PWR SR1 EXT_SMPS_RDY bit definition for WLCSP82 package with Ext SMPS

- stm32l4xx.h
  - Add new atomic register access macros.
