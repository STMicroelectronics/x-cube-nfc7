/**
  ******************************************************************************
  * @file           : ndef_poller.h
  * @brief          : This file provides several functionalities required to perform NFC NDEF activities. 
  *                   The NDEF encapsulates the different tag technologies (T2T, T3T, T4AT, T4BT, T5T)
